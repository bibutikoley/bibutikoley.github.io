...
import{n as e,t}from"./index-j2LLdT79.js";import{A as n,C as r,D as i,L as a,M as o,N as s,O as c,P as l,R as u,S as d,T as f,_ as p,a as m,b as h,c as g,f as _,g as v,h as y,i as b,j as x,m as S,n as C,o as w,p as T,r as E,t as D,u as O,v as k,w as A,y as j,z as M}from"./three-C37LD9ZS.js";function N(){let e=e=>typeof matchMedia==`function`&&matchMedia(e).matches,t=e(`(prefers-reduced-motion: reduce)`),n=e(`(pointer: coarse)`),r=!1;try{let e=document.createElement(`canvas`);r=!!(e.getContext(`webgl2`)||e.getContext(`webgl`))}catch{r=!1}let i=navigator.hardwareConcurrency||4,a=navigator.deviceMemory||8,o=window.innerWidth<720,s=`mid`;o||i<=4||a<=4?s=`low`:i>=8&&(window.devicePixelRatio||1)>=1.5&&(s=`high`);let c=Math.min(window.devicePixelRatio||1,s===`low`?1.25:2),l={low:6e3,mid:14e3,high:24e3}[s];return{webgl:r,reducedMotion:t,coarse:n,tier:s,dpr:c,particles:l,bloom:s!==`low`&&!t}}var P=`vec3 mod289(vec3 x) { return x - floor(x * (1.0 / 289.0)) * 289.0; }
